...
/*
static void dump_array(json_t *root) {
    size_t index;
    json_t *value;
...
char *finalize(char *buffer, size_t chunksz) {
...
// chunks tools
//
int bufferise(char *buffer, char *file, size_t size, size_t offset) {
    FILE *fp;
...
json_t *chunks(char *root, const char **files, size_t length, size_t chunksz) {
